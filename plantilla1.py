...
<body>
    <div class="container">
        ...
        <div class="form-section">
            <h2>📝 Completa los datos de las filas 3 y 4</h2>
            
            <form id="dataForm" method="POST" action="/descargar">
                <div class="row-label">🔸 Fila 3 - Gestor de servicios (1hrs-2hrs)</div>
                <div class="form-grid">
                    <div class="form-group">
                        <label>Nombre:</label>
                        <input type="text" name="nombre3" id="nombre3" placeholder="Ej: Alonso Pardo" value="Alonso Pardo" required>
                    </div>
                    <div class="form-group">
                        <label>Teléfono:</label>
                        <input type="text" name="telefono3" id="telefono3" placeholder="Ej: 939 111 626" value="939 111 626" required>
                    </div>
                    <div class="form-group">
                        <label>Correo:</label>
                        <input type="email" name="correo3" id="correo3" placeholder="Ej: ejemplo@bitel.com.pe" value="pardolanamachia@bitel.com.pe" required>
                    </div>
                </div>

                <div class="divider"></div>

                <div class="row-label">🔸 Fila 4 - Gerente de Cuenta (2hrs-3hrs)</div>
                <div class="form-grid">
                    <div class="form-group">
                        <label>Nombre:</label>
                        <input type="text" name="nombre4" id="nombre4" placeholder="Ej: Carlos Rojas" value="Carlos Rojas" required>
                    </div>
                    <div class="form-group">
                        <label>Teléfono:</label>
                        <input type="text" name="telefono4" id="telefono4" placeholder="Ej: 930 935 871" value="930 935 871" required>
                    </div>
                    <div class="form-group">
                        <label>Correo:</label>
                        <input type="email" name="correo4" id="correo4" placeholder="Ej: ejemplo@bitel.com.pe" value="carlos.rojas@bitel.com.pe" required>
                    </div>
                </div>
            </form>
        </div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Responsable en Turno</td><td>0 800 79079</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>Responsable en Turno<br>Residente:<br>Miguel Bimadi</td>
                        <td>905 785 250</td>
...
def crear_documento_word(datos):
    """Crea el documento Word con la matriz de escalamiento EXACTAMENTE como en la imagen"""
...
if __name__ == '__main__':
    print("=" * 60)
    print("PLANTILLA 1 INICIADA (Filas 3 y 4)")
    print("=" * 60)
    print("Abre tu navegador en: http://localhost:5001")
    print("Volver al menú: http://localhost:5000")
